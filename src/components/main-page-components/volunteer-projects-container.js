...
const VolunteerProjectsContainer = () => {
    ...
    return <div className="volunteer_projects_container">
        <div className="volunteer_projects_container_header">
            <h2 className="volunteer_projects_container_header_h2">
                المشاريع التطوعية
            </h2>
            <h1 className="volunteer_projects_container_header_h1">
                اكتشف افضل واشمل المشاريع التطوعية
            </h1>
        </div>
        <div className="volunteer_projects_cards">
            {
                volunteerProjects.map((project, index) =>
                    <div key={index} className="volunteer_projects_card">
                        <img src={project.img} alt="" className="volunteer_projects_card_image" />
                        <div className="volunteer_projects_card_details">
                            <div className="volunteers_card_date_h1">
                                ...
                                <h1 className="volunteer_projects_card_details_h1">
                                    {project.title}
                                </h1>
                            </div>
                            ...
                            <button className="volunteer_view_project_btn">
                                عرض المشروع
                                <SmallLeftArrow />
                            </button>
                        </div>
